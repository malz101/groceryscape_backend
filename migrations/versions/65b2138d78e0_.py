...
Revision ID: 65b2138d78e0
Revises: 1addc3d20363
Create Date: 2021-05-10 17:46:28.708985
...
revision = '65b2138d78e0'
down_revision = '1addc3d20363'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    op.create_unique_constraint(None, 'grocery', ['name'])
