...
def upgrade():
    ...
    op.add_column('orders', sa.Column('delivery_parish', sa.String(length=45), nullable=True))
    op.add_column('orders', sa.Column('delivery_town', sa.String(length=45), nullable=True))
...
def downgrade():
    # ### commands auto generated by Alembic - please adjust! ###
    op.add_column('orders', sa.Column('delivery_town', sa.VARCHAR(length=45), server_default=sa.text('NULL::character varying'), autoincrement=False, nullable=True))
    op.add_column('orders', sa.Column('delivery_date', postgresql.TIMESTAMP(), autoincrement=False, nullable=True))
    op.add_column('orders', sa.Column('delivery_parish', sa.VARCHAR(length=45), server_default=sa.text('NULL::character varying'), autoincrement=False, nullable=True))
